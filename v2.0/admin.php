...
<html lang="en">
	<head>
		...
		<link rel="apple-touch-icon" sizes="250x250" href="assets/images/patchy.jpg">
		<link rel="icon" href="assets/images/patchy.jpg" type="image/gif">
		<style type="text/css"> 
			body { 
		...
		<div id="main">
			...
			<div id="content">
				...
				<div id="header">
					<div class="a-cp-tarea">
						...
						<h4><?php if (!checkPatchyVersion()) { echo "<span id=\"update-me\">A newer version of Patchy is available <a href='https://github.com/jake-cryptic/patchy'>here</a></span>"; } else { echo "Patchy is up to date"; } ?></h4>
					</div>
				</div>
			...
			<div id="content">
				...
				<div id="header">
					...
					<table class="dark-table dark-table-small">
						<thead>
							<tr>
								<th>UserID</th>
								<th>Username</th>
