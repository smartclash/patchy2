<div id="main">
	...
	<div id="content">
				...
				if (is_numeric($_GET["msg"])) {
					...
					switch ($msg){
						...
						case 3:
							...
							break;
						case 4:
							echo "<span class=\"statusMsgErr\">Unknown error occurred, contact support";
							break;
						case 5:
		...
		<div id="uploadArea">
			<p id="uploadSteps">
				Uploading an <strong>individual</strong> patch:<br />
				1) Generate the patch<br />
				2) Zip up the <strong>new</strong> patch folder<br />
				3) Upload below<br />
				4) Go to the Patch Manager and press UnZip next to the patch you just uploaded<br />
