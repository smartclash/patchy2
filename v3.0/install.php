...
class PatchyInstaller {
	private function showWelcome() {
		echo '<div id="titleBox">
			...
			<span id="PatchyInstallerVersion">Intended for Patchy 3.0</span><br />
	...
	private function getDbInfo() {
		echo '<div id="titleBox">
			...
			<form action="install.php?c=3" method="post" name="installForm">
				...
				Be aware that the db.php file in assets/php/main/ will be over written with new details<br />
	...
	private function attemptInstall() {
		...
		if (!empty($_POST)) {
			...
			if (!empty($_POST["db-host"] || $_POST["db-user"] || $_POST["db-pass"])) {
				...
				fclose($db_file);
				echo "<span style='color:green;font-size:1.2em;'>Database (db.php) file was generated and moved to /assets/php/main/</span><br />"; ob_flush();flush();
